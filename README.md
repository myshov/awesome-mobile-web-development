...
- [60 FPS on Mobile Web](http://engineering.flipboard.com/2015/02/mobile-web) - how to make the really fast mobile website (by Flipboard).
...
- [Mobile Web Best Practices](https://www.w3.org/TR/mobile-bp/) - a little bit old but still useful list of best practices for mobile websites from W3C.
...
- [Who Killed My Battery](https://mobisocial.stanford.edu/papers/boneh-www2012.pdf) - an interesting paper about power consumption of websites.
...
- [Battery API](https://www.w3.org/TR/battery-status/) - an access to information about the battery.
...
- [Payment Request API](https://www.w3.org/TR/payment-request/) - a payment method with minimal integration.
...
- [Visual Viewport API](https://wicg.github.io/visual-viewport/) - an access to a visual portion of a screen excluding on-screen keyboards, areas outside of a pinch-zoom area etc..
